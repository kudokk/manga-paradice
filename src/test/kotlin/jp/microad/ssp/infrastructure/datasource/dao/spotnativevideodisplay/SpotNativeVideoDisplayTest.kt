...
@DisplayName("SpotNativeVideoDisplayのテスト")
private class SpotNativeVideoDisplayTest {
    @Nested
    ...
    inner class IsDisplayControlTest {
        ...
        private fun entity(top: Int?, bottom: Int?, left: Int?, right: Int?) =
            SpotNativeVideoDisplay(mock(), mock(), top, bottom, left, right, false, null, null, null, null, null)
    }
}
