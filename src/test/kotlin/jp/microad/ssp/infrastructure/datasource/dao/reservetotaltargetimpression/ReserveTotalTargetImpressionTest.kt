...
@DisplayName("ReserveTotalTargetImpressionのテスト")
private class ReserveTotalTargetImpressionTest {
    @Nested
    ...
    inner class IsNotEndByTest {
        ...
        private fun sut(date: LocalDate?) = ReserveTotalTargetImpression(1, mock(), date, 1, mock(), mock())
    }
}
