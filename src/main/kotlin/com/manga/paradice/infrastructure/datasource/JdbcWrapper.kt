package com.manga.paradice.infrastructure.datasource

import com.manga.paradice.infrastructure.datasource.mapper.CustomBeanPropertySqlParameterSource
import com.manga.paradice.infrastructure.datasource.mapper.CustomMapSqlParameterSource
import com.manga.paradice.infrastructure.datasource.mapper.KDataClassRowMapper
...
/**
 * MANGAKAでの利用に合わせたJdbcTemplateの拡張
 */
class JdbcWrapper(
